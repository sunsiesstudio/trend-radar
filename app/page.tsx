...
export default function HomePage() {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "#eaeaea", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      {appliedTopics.length > 0 && (
        <div style={{
          ...
          background: "#eaeaea", borderBottom: "1px solid rgba(0,0,0,0.05)",
